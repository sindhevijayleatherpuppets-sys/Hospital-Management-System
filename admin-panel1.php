...
<html lang="en">
  ...
  <a class="navbar-brand" href="#" style="display: flex; align-items: center; gap: 12px;"><img src="images/logo.png" alt="Logo" style="height: 45px; width: auto; object-fit: contain;"> <span style="font-weight: 700; font-size: 1.25rem;">Dhanvanthari Ayurveda Hospital</span> </a>
          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                    <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Panchakarma Specialist" name="spec">Panchakarma Specialist</option>
                      <option value="Nadi Pariksha" name="spec">Nadi Pariksha</option>
                      <option value="Ayurvedic Consultation" name="spec">Ayurvedic Consultation</option>
                      <option value="PCOS / PCOD Management" name="spec">PCOS / PCOD Management</option>
                      <option value="Spine & Joint Disorders" name="spec">Spine & Joint Disorders</option>
                      <option value="Arthritis & Rheumatic Care" name="spec">Arthritis & Rheumatic Care</option>
                      <option value="Diabetes Management" name="spec">Diabetes Management</option>
                      <option value="Weight Loss Counselling" name="spec">Weight Loss Counselling</option>
                      <option value="Allergy Treatment" name="spec">Allergy Treatment</option>
                      <option value="Digestive Disorders" name="spec">Digestive Disorders</option>
                      <option value="Lifestyle & Wellness Consultation" name="spec">Lifestyle & Wellness Consultation</option>
                    </select>
                    </div><br><br>
