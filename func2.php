...
<html lang="en">
  ...
  <a class="navbar-brand" href="#" style="display: flex; align-items: center; gap: 10px;"><img src="images/logo.png" alt="Logo" style="height: 35px; width: auto; border-radius: 4px;"> Dhanvanthari Ayurveda Hospital </a>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="doctor" class="form-control" >
                      ...
                      <!-- <option value="Dr. Krishnamoorthy BS">Dr. Krishnamoorthy BS, B.A.M.S.</option> -->
                      <?php display_docs();?>
