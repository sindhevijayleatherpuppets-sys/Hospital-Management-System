...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 5px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif; display: flex; align-items: center; gap: 10px;">
        <img src="images/logo.png" alt="Dhanvanthari Logo" style="height: 45px; width: auto; border-radius: 5px;">
        <h4 style="margin: 0; font-weight: 600;">DHANVANTHARI AYURVEDA HOSPITAL</h4>
      </a>
